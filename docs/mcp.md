...
| `list_hypotheses`           | `strategy_id`, `limit?`                                                                                 | 接続元戦略の仮説 + account-wide (global, `strategy_id IS NULL`) 仮説を新しい順に返す。他戦略専属の仮説は含まない                                                                                                                                                                                                                                                                                                                                                           |
| `read_hypothesis`           | `strategy_id`, `hypothesis_id`                                                                          | 仮説 1 件のタイトル / 本文 / status を返す。自戦略または global の仮説のみ許可、他戦略専属の仮説は reject                                                                                                                                                                                                                                                                                                                                                                  |
