//! Markdown 本文と図に含まれる token を分類し、妥当性を検証する。
...
pub(super) enum NoteTokenValidationError {
...
pub(super) enum BodyTokenPolicy {
    Validate,
...
pub(super) fn collect_note_refs(
    body: &str,
    graphs: &[GraphDef],
...
pub(super) fn collect_note_refs_with_policy(
    body: &str,
    graphs: &[GraphDef],
