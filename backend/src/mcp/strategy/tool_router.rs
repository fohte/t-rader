...
use super::dto::{
    ...
    ReadCommentsResult, ReadHypothesisParams, ReadNewsParams, ReadNewsResult, ReadNoteParams,
    ReadPortfolioResult, RecordPredictionParams, RecordPredictionResult, ReplyCommentParams,
