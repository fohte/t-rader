...
use super::dto::{
    ...
    ReadNewsParams, ReadNewsResult, ReadNoteParams, ReadPortfolioResult,
    ReadShareholdingStructureParams, ReadShareholdingStructureResult, RecordPredictionParams,
