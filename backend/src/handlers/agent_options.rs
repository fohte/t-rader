        ...
        assert_eq!(
            ...
            serde_json::json!({
                "tools": [
                    ...
                    {"name": "read_portfolio", "description": "Return account-wide open positions and realized P&L (FIFO), aggregated across all strategies regardless of the connecting strategy. Use this to check existing holdings before proposing new trades."},
